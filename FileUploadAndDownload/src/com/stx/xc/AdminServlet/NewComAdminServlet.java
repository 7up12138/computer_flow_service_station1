...
/**
 * Servlet implementation class NewComAdminServlet
 */
@WebServlet("/NewComAdminServlet")
public class NewComAdminServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NewComAdminServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
	       ...
	       // String newjsd =request.getParameter("newjsd");
	        ...
	        int m=lla.insertcom(username,password);
	        if(m>0){
