...
public class CheckFile extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       boolean flag= listfile(new File(uploadFilePath),fileNameMap);//File既可以代表一个文件也可以代表一个目录
        //将Map集合发送到listfile.jsp页面进2行显示
...
//        
   ...
   //Description: 递归遍历指定目录下的所有文件
    ...
    public boolean listfile(File file,Map<String,String> map){
