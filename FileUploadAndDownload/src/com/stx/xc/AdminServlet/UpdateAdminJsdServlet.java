...
/**
 * Servlet implementation class UpdateAdminJsdServlet
 */
@WebServlet("/UpdateAdminJsdServlet")
public class UpdateAdminJsdServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateAdminJsdServlet() {
        super();
