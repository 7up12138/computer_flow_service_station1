...
<body style="background-image:url(images/slide-2.jpg);color:white;">
 ...
 <%  
   ...
   %>
   <center>
   <table  cellspacing="7" cellpadding="7" style="font-family:'微软雅黑'">
  <tr>
  ...
  <td style="text-align:center">
<form action="/FileUploadAndDownload/DeleteAdminServlet" method="post">
...
<input type="hidden" name="adminusername" value="<%=uname %>">
<input type="hidden"  name="pwd" value="<%=am.getUseranme() %>"/>
<input type="submit" value="修改密码" />
</form>
<form action="/FileUploadAndDownload/Admin/Updatejsd.jsp" method="post" >
<input type="hidden" name="adminuname" value="<%=uname %>">
<input type="hidden"  name="jsd" value="<%=am.getUseranme() %>"/>
<input type="hidden"  name="jsd2" value="<%=am.getFlag()%>"/>
<input type="submit" value="修改权限"/>
   ...
   <td colspan="4" style="text-align:center;">
	<h3><a href="/FileUploadAndDownload/Admin/newadmin.jsp" >设置新的管理员</a></h3>
   </td>
   </tr>
   </table>
   </center>
