...
<div id="selectbigbox" style="margin-top:75px">
	...
	<form action="update.do" id="myform">
		...
		图片路径:<input type="text" id="f"  value="${bb}" name="tp" class="aip"/><br>


		<div class="aaaa"><img src="${bb}" style="width: 210px;height: 330px;margin-top:-60px;margin-left: -25px;"></div>
