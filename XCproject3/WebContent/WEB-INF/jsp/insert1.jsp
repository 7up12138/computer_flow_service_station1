...
<style type="text/css">
	*{ margin:0; padding:0;font-family: "微软雅黑";}
	...
	#selectbigbox{top: 0px;left: 0px;width: 550px;height:430px;margin-left:32%;padding-bottom:10px;background: rgba(255,255,255,0.2);border-radius: 5px;padding-top: 10px;}
...
<div id="selectbigbox" style="margin-top:75px">
	...
	<form action="photo.do" method="post" enctype="multipart/form-data">
		...
		<p id="oa"><b style="color: #fff;">上传照片</b><input type="file" id="content" name="file1" ></p>
		<br/>
	...
	<form action="insert1.do" id="myform">
		...
		技师姓名:<input type="text"  name="name" class="aip"><br><br>
		技师年级:<input type="text"  name="nj" class="aip"><br><br>
		技师专业:<input type="text"  name="zy" class="aip"><br><br>
		技师简介:<input type="text"  name="jj" class="aip"><br><br>
		电子邮件:<input type="text"  name="emil" class="aip"><br><br>
		图片路径:<input type="text" id="f" value="${qq}"  name="tp" class="aip"/><br>


		<div class="aaaa"><img src="/XCproject3/${qq}" style="width: 210px;height: 330px;margin-top:-60px;margin-left: -25px;"></div>

		<input type="submit" value="提交" id="sure1" style="margin-top:20px;">
	</form>
	</div>
</div>
